...
class LoadingPredictions(Experiment):
    ...
    def plot(self, results):
        ...
        x_train, x_test, y_train, y_test = self.get_train_test_rms_data(results['train_beta_by_class'], results['test_beta_by_class'], idx_layer, num_to_average)
    ...
    def get_train_test_rms_data(train_beta_by_class, test_beta_by_class, idx_layer, num_average):
        ...
        x_group_train = [tbc[idx_layer][:, :, :num_average*num_groups_train].reshape(num_classes, num_nodes, num_groups_train, num_average) for tbc in train_beta_by_class]
        x_group_test = [tbc[idx_layer][:, :, :num_average*num_groups_test].reshape(num_classes, num_nodes, num_groups_test, num_average) for tbc in test_beta_by_class]
